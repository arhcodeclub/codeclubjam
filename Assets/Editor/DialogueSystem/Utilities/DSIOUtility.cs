...
namespace Dialogue.Utilities
{
    ...
    public static class DSIOUtility
    {
        ...
        public static void Initialize(DSGraphView dsGraphView, string graphName)
        {
            ...
            containerFolderPath = $"Assets/Engine/DialogueSystem/Dialogues/{graphName}";
        ...
        public static void Load()
        {
            ...
            List<DSNode> nodes = LoadNodes(graphData.Nodes);
            LoadNodesConnections();


            foreach(DSNode n in nodes){
                n.OnFinishedLoading();
            }
        ...
        private static List<DSNode> LoadNodes(List<DSNodeSaveData> nodes)
        {
            List<DSNode> createdNodes = new List<DSNode>();
        ...
        private static void CreateDefaultFolders()
        {
            ...
            CreateFolder("Assets/Engine", "DialogueSystem");
            CreateFolder("Assets/Engine/DialogueSystem", "Dialogues");

            CreateFolder("Assets/Engine/DialogueSystem/Dialogues", graphFileName);
