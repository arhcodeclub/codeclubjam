...
namespace Dialogue.Inspectors
{
    ...
    public class DSInspector : Editor
    {
        ...
        {
            DSDialogue dsDialoue = (DSDialogue)target;
            if (dsDialoue.GetComponent<Collider2D>())
            {
                EditorGUILayout.HelpBox("This component derives from interactable and will be interactable because it has a collider", MessageType.Info);
            }
            ...
            string dialogueFolderPath = $"Assets/Engine/DialogueSystem/Dialogues/{currentDialogueContainer.FileName}";
        ...
        private void DrawDialogueGroupArea(DSDialogueContainerSO dialogueContainer, List<string> dialogueGroupNames)
        {
            ...
            DSDialogueGroupSO selectedDialogueGroup = DSIOUtility.LoadAsset<DSDialogueGroupSO>($"Assets/Engine/DialogueSystem/Dialogues/{dialogueContainer.FileName}/Groups/{selectedDialogueGroupName}", selectedDialogueGroupName);
